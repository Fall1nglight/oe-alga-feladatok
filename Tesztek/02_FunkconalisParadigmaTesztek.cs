...
namespace OE.ALGA.Tesztek.Paradigmak
{
    ...
    public class FeltetelesFeladatTaroloTesztek
    {
        ...
        {
            FeltetelesFeladatTarolo<TesztFeladat> tarolo =
                new FeltetelesFeladatTarolo<TesztFeladat>(3);
            TesztFeladat a = new TesztFeladat("a");
            tarolo.Felvesz(a);
            tarolo.Felvesz(a);
            tarolo.Felvesz(a);
        ...
        {
            FeltetelesFeladatTarolo<TesztFeladat> tarolo =
                new FeltetelesFeladatTarolo<TesztFeladat>(2);
        ...
        public void FeltetelesVegrehajtas()
        {
            ...
            tarolo.FeltetelesVegrehajtas(x =>
            {
                Guardian.Recursion.CheckStackTrace();
                return x.Azonosito[0] == 'a';
            }); // csak 'a' kezdetűek végrehajtása
            Assert.Multiple(() =>
            {
            ...
            {
                Guardian.Recursion.CheckStackTrace();
                return x.Azonosito[0] == 'b';
            }); // csak 'b' kezdetűek végrehajtása
            Assert.Multiple(() =>
            {
                Assert.That(a1.Vegrehajtott, Is.True);
        ...
        public void FeltetelesFuggosegesVegrehajtas()
        {
            ...
            {
                Guardian.Recursion.CheckStackTrace();
                return x.Azonosito[0] == 'a' && x.FuggosegTeljesul;
            }); // csak 'a' kezdetű és végrehajtható
            Assert.Multiple(() =>
            {
                Assert.That(a1.Vegrehajtott, Is.True);
                Assert.That(b1.Vegrehajtott, Is.False);
            ...
            {
                Guardian.Recursion.CheckStackTrace();
                return x.Azonosito[0] == 'b' && x.FuggosegTeljesul;
            }); // csak 'b' kezdetű és végrehajtható
            Assert.Multiple(() =>
            {
                Assert.That(a1.Vegrehajtott, Is.True);
                Assert.That(b1.Vegrehajtott, Is.True);
        ...
        public void FeltetelesBejaro()
        {
            FeltetelesFeladatTarolo<TesztFuggoFeladat> tarolo =
                new FeltetelesFeladatTarolo<TesztFuggoFeladat>(10);
            tarolo.BejaroFeltetel = (
                x =>
                {
                    Guardian.Recursion.CheckStackTrace();
                    return x.FuggosegTeljesul;
                }
            );
