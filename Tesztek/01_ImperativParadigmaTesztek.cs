...
namespace OE.ALGA.Tesztek.Paradigmak
{
    ...
    public class FuggoFeladatTaroloTesztek
    {
        ...
        public void Felvesz()
        {
            FuggoFeladatTarolo<TesztFuggoFeladat> tarolo =
                new FuggoFeladatTarolo<TesztFuggoFeladat>(5);
        ...
        {
            FuggoFeladatTarolo<TesztFuggoFeladat> tarolo =
                new FuggoFeladatTarolo<TesztFuggoFeladat>(3);
            TesztFuggoFeladat a = new TesztFuggoFeladat("a");
            tarolo.Felvesz(a);
            tarolo.Felvesz(a);
            tarolo.Felvesz(a);
        ...
        {
            FuggoFeladatTarolo<TesztFuggoFeladat> tarolo =
                new FuggoFeladatTarolo<TesztFuggoFeladat>(2);
            tarolo.MindentVegrehajt();
        }
    ...
    [TestFixture(
        Category = "Paradigmák",
        TestName = "01 - Feltételes Feladat Tároló Előkövetelményekkel Tesztek"
    )]
    public class FuggoFeladatTaroloElokovetelmenyekkelTesztek
    {
        ...
        public void Elokovetelmenyes()
        {
            FuggoFeladatTarolo<TesztFuggoFeladat> tarolo =
                new FuggoFeladatTarolo<TesztFuggoFeladat>(5);
            TesztFuggoFeladat a = new TesztFuggoFeladat("a");
            TesztElokovetelmenytolFuggoFeladat b = new TesztElokovetelmenytolFuggoFeladat("b", a)
            {
                Vegrehajthato = true,
            };
            // a->b
        ...
        public void TobbKorosElokovetelmenyes()
        {
            ...
            TesztElokovetelmenytolFuggoFeladat c = new TesztElokovetelmenytolFuggoFeladat("c", a)
            {
                Vegrehajthato = true,
            };
            TesztElokovetelmenytolFuggoFeladat d = new TesztElokovetelmenytolFuggoFeladat("d", b)
            {
                Vegrehajthato = true,
            };
            // a->b->d
