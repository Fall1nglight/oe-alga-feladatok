...
namespace OE.ALGA.Tesztek.Optimalizalas
{
    ...
    public class HatizsakTesztek
    {
        ...
        {
            HatizsakProblema problema = new HatizsakProblema(
                PakolasTesztEsetek.jegyzet_n,
                PakolasTesztEsetek.jegyzet_Wmax,
                PakolasTesztEsetek.jegyzet_w,
                PakolasTesztEsetek.jegyzet_p
            );
            Assert.Multiple(() =>
            {
                Assert.That(problema.OsszSuly(PakolasTesztEsetek.uresPakolas), Is.EqualTo(0));
    ...
    public class NyersEroTesztek
    {
        ...
        public void UresTeszt()
        {
            ...
            NyersEro<int> opt = new NyersEro<int>(
                ...
                x =>
                {
                    Guardian.Recursion.CheckStackTrace();
                    return A[x - 1];
                },
                x =>
                {
    ...
    public class NyersEroHatizsakPakolasTesztek
    {
        ...
        public void JegyzetbenLevoPeldaErtekTeszt()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(
                    opt.OptimalisErtek(),
                    Is.EqualTo(PakolasTesztEsetek.jegyzet_optimalis_ertek)
                );
        ...
        public void JegyzetbenLevoPeldaMegoldasTeszt()
        {
            ...
            {
                Assert.That(
                    opt.OptimalisMegoldas(),
                    Is.EquivalentTo(PakolasTesztEsetek.jegyzet_optimalis_pakolas)
                );
                Assert.That(opt.LepesSzam, Is.EqualTo(63));
            });
        }
        ...
        {
            HatizsakProblema problema = new HatizsakProblema(
                PakolasTesztEsetek.nagy_n,
                PakolasTesztEsetek.nagy_Wmax,
                PakolasTesztEsetek.nagy_w,
                PakolasTesztEsetek.nagy_p
            );
            NyersEroHatizsakPakolas opt = new NyersEroHatizsakPakolas(problema);
            Assert.Multiple(() =>
            {
                Assert.That(
                    opt.OptimalisErtek(),
                    Is.EqualTo(PakolasTesztEsetek.nagy_optimalis_ertek)
                );
        ...
        public void NagyPeldaMegoldasTeszt()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(
                    opt.OptimalisMegoldas(),
                    Is.EquivalentTo(PakolasTesztEsetek.nagy_optimalis_pakolas)
                );
                Assert.That(opt.LepesSzam, Is.EqualTo(131071));
            });
        }
